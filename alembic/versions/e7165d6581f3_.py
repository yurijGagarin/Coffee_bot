...
def upgrade() -> None:
    ...
    menu_items = [
        ...
        {'name': 'Аеропресс', 'price': 65, 'is_coffee': True, 'is_black_coffee': True,
         'description':
             "Різновид фільтр кави, який готується у девайсі під назвою 'Aeropress'."
             " 'Aeropress' настільки універсальний, що в ньому можна готувати каву різними способами"
             " Є можливість обрати каву на свій смак",
         'volume': '200 мл'},
        {'name': 'Дельтер', 'price': 65, 'is_coffee': True, 'is_black_coffee': True,
         'description':
             "Різновид фільтр кави, який готується методом імерсїї, у девайсі під назвою 'Delter'."
             " Є можливість обрати каву на свій смак",
         'volume': '200 мл'},

        {'name': 'Капучино', 'price': 40, 'is_coffee': True, 'is_milk': True,
         'description':
             "Кавово-молочний напій основою якого є еспресо,"
        ...
        {'name': 'Айс Лате', 'price': 45, 'is_coffee': True, 'is_milk': True, 'is_cold': True,
         'description':
             "Порція еспресо, лід та молоко. Гарно смакує у спеку.",
         'volume': '270 мл'},
        ...
        {'name': 'Флет Уайт', 'price': 45, 'is_coffee': True, 'is_milk': True,
         'description':
             "Кавово-молочний напій основою якого є подвійний еспресо,"
             " з правильним вмішуванням в нього взбитого молока",
         'volume': '180 мл'},
        ...
        {'name': 'Раф', 'price': 65, 'is_coffee': True, 'is_milk': True,
         'description':
             "Напій на основі молока, рослинних вершків та еспресо",
         'volume': '280 мл'},
